...
<form action="/E_Tutors/SearchCoachingByClassAndSubAndCity" method="post" class="thisform">

<p align="left">City</p>
    <input type="text" placeholder="Enter The City" name="SearchedCity" id="SearchedCity" minlength="1"  required><br><br>
