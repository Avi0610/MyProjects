...
<form action="/E_Tutors/UpdateCoachingProfile" method="post" class="thisform">
 <P align="left">Email: </P> 
<input type="email" placeholder="enter your email address" name="email" id="email" minlength="1" value="${requestScope.coachingDet.email}" required><br><br>
...
<input type="text" placeholder="enter your mobile no" name="mobileNo" id="mobileNo" pattern="[0-9]{10}" maxlength="10" minlength="10" oninvalid="this.setCustomValidity('Enter the correct mobile mobile of length 10(Number Only)')"
    oninput="this.setCustomValidity('')" value="${requestScope.coachingDet.mobile}" required><br><br>
...
<P align="left">Current City: </P>
 <input type="text" placeholder="enter your Current City" name="city" id="city" minlength="1" pattern="[A-Za-z\s]+" oninvalid="this.setCustomValidity('City Name Will Contain Characters Only')"
    oninput="this.setCustomValidity('')" value="${requestScope.coachingDet.city}" required><br><br>
...
<input type="text" placeholder="enter your name" pattern="[A-Za-z\s]+" name="name" id="name" minlength="1" oninvalid="this.setCustomValidity('Enter The Correct name Without any Number')"
    oninput="this.setCustomValidity('')" width="48" height="48" value="${requestScope.coachingDet.institutionName}" required><br><br>




<P align="left">Add Some Description: </P>
<textarea rows="3" cols="50" name="description" id="description"  placeholder="enter the basic details" required>${requestScope.coachingDet.details}</textarea><br><br>

<P align="left">Password: </P>
<input type="password" name="password" id="password" placeholder="enter your Password" minlength="1" maxlength="20" value="${requestScope.coachingDet.password}" required><br><br>
