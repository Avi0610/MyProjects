...
<div class="slideshow-container">
  ...
  <div class="mySlides fade">
    ...
    <img src="/E_Tutors/resources/images/cd1.jpg" width="100px" height="400" class="img">
    <div class="text">Image One</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="/E_Tutors/resources/images/cd2.jpg" width="400" height="400" class="img">
    <div class="text">Image Two</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="/E_Tutors/resources/images/cd3.jpg" width="400" height="400" class="img">
