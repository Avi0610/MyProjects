...
/**
 * Servlet implementation class SearchTutorByPinCodeAndSubAndClass
 */
@WebServlet("/SearchTutorByPinCodeAndSubAndClass")
public class SearchTutorByPinCodeAndSubAndClass extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchTutorByPinCodeAndSubAndClass() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("SearchedPinCode") != null && request.getParameter("SearchedPinCode").trim().length() > 0) {
			...
			listTutors = tutorSearchingConditionsDaos.findByTutorBySubjectClassPinCode(SearchedSubject, SearchedClass, pinCode);
