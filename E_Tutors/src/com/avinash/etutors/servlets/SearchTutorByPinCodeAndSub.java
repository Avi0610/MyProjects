...
/**
 * Servlet implementation class SearchTutorByPinCodeAndSub
 */
@WebServlet("/SearchTutorByPinCodeAndSub")
public class SearchTutorByPinCodeAndSub extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchTutorByPinCodeAndSub() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("SearchedPinCode") != null && request.getParameter("SearchedPinCode").trim().length() > 0) {
			...
			subject = new String(request.getParameter("SearchedSubject"));
			...
			listTutors = tutorSearchingConditionsDaos.findByTutorSubjectAndPinCode(subject, pinCode);
