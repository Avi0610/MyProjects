...
public class WareHouseSupplyTableModel extends AbstractTableModel {
	ArrayList<WareHouseSupply> whsList;
	String columns[] = {"w_h_supply_id", "p_id", "store_id", "quantity"};
	
	public WareHouseSupplyTableModel(Integer whsId) {
		WareHouseSupplyDao whsd  = new WareHouseSupplyDao();
		whsList  = whsd.findBysupplyId(whsId);
	}
