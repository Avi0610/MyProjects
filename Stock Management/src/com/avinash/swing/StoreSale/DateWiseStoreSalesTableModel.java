...
public class DateWiseStoreSalesTableModel extends AbstractTableModel {
	...
	public  DateWiseStoreSalesTableModel(java.util.Date date, Integer storeId) {
		StoreSalesDao ssd  = new StoreSalesDao();
		sellingList = ssd. findAllSalesById(date,storeId);
